  ...
  return (
    <header className='relative w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light z-10 lg:px-16 md:px-12 sm:p-8'>
        ...
        <div className='w-full flex justify-between items-center lg:hidden'>
            <nav>
                <CustomLink href="/signup" title="SignUp" className='mx-4' />
                <CustomLink href="/login" title="Login To View Portfolio" className='mx-4' />
            </nav>
            ...
            isOpen ? 
                <motion.div initial={{scale:0, opacity:0, x: "-50%", y:"-50%"}} animate={{scale: 1, opacity:1}} 
                    ...
                    <nav className='flex items-center flex-col justify-center'>
                        <CustomMobileLink href="/signup" title="SignUp" className='' toggle = {handleClick}/>
                        <CustomMobileLink href="/login" title="Login To View Portfolio" className='' toggle = {handleClick}/>
                    </nav>
